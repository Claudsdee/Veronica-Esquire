      ...
      (function(t, i) {
        ...
        function s(e) {
          ...
          return (
            ...
            s.length
              ? ("0,0,0,0" === s.join() && t.extend(s, r.transparent), a)
              : r[e]
          );
        }
        function n(e, t, i) {
        ...
        function a(t, i) {
          ...
          for (a in i)
            (s = i[a]),
              t[a] !== s &&
                (n[a] ||
                  ((e.fx.step[a] || !isNaN(parseFloat(s))) && (r[a] = s)));
          return r;
        }
        ...
        e.each(
          ...
          e.fn.extend({
            ...
            addClass: function(t, i, a, s) {
              return i
                ? e.effects.animateClass.call(this, { add: t }, i, a, s)
                : this._addClass(t);
            },
            _removeClass: e.fn.removeClass,
            removeClass: function(t, i, a, s) {
              return i
                ? e.effects.animateClass.call(this, { remove: t }, i, a, s)
                : this._removeClass(t);
            },
            ...
            toggleClass: function(i, a, s, n, r) {
              return "boolean" == typeof a || a === t
                ...
                : e.effects.animateClass.call(this, { toggle: i }, a, s, n);
            },
        ...
        e.extend(e.effects, {
          ...
          restore: function(e, i) {
            ...
            for (n = 0; i.length > n; n++)
              null !== i[n] &&
                ((s = e.data(a + i[n])), s === t && (s = ""), e.css(i[n], s));
          },
